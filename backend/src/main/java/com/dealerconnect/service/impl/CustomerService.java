...
import com.dealerconnect.dto.request.CustomerRequest;
import com.dealerconnect.entity.Customer;
import com.dealerconnect.entity.CustomerAddress;
import com.dealerconnect.exception.ResourceNotFoundException;
import com.dealerconnect.repository.CustomerRepository;
...
public class CustomerService {
    ...
    public Customer getById(Long id) {
        ...
        return customerRepo.findById(id)
            .filter(c -> DealerContext.isCurrentSuperAdmin() || (c.getDealer() != null && c.getDealer().getId().equals(dealerId)))
    ...
    public Customer update(Long id, CustomerRequest req) {
        ...
        try {
            ...
            log.error("Failed to serialize customer for update audit: {}", e.getMessage());
        }
    ...
    public void delete(Long id) {
        ...
        try {
            ...
            log.error("Failed to serialize customer for delete audit: {}", e.getMessage());
        }
